A pasta **AirLib** contem as coisas relacionadas ao sistema de ui
sendo as principais:

**AirConfig** contem algumas configurações relacionadas ao tema que a interface vai utilizar sendo sprites com nine slice, ou geradas com draw e as cores selecionadas.

**AirFunctions** que contem os elementos de UI e outras funções que utilizo em meus projetos.

**FlexPanel** que contem toda a logica relaciona a UI.
